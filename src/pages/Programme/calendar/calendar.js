...
import {
  Button, Typography, ButtonGroup, Dialog, DialogTitle,
  DialogContent, DialogActions, Grid, useMediaQuery, useTheme,
  TextField, InputLabel, Box, Container
} from '@mui/material';
                  ...
                  (<DialogContent>
                    <Grid container spacing={3} justifyContent="center" alignItems="center" >
                      <form onSubmit={onSubmitUpdate}>
                        <Grid sx={{ alignItems: 'center', paddingTop: "10px" }}>
                ...
                {!updateMode ?
                  (
                    <>
                      ...
                      <Button onClick={() => handleUpdateEventSelect(selectedEvent)}>
                        modifier
                      </Button>
