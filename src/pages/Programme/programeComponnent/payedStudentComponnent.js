    ...
    try {
      ...
      if (result.code === 200) {
       ...
       console.log(payments);
        setData(payments);
        // Calculate counts for "with Group" and "without Group" if needed
        const groupCounts = payments.reduce((acc, current) => {
          const { group } = current;
          if (group) {
  ...
  <div className="col-md-12 col-xl-4 col-12">
    <div className="card mb-5">
      <div className="card-header d-flex justify-content-between align-items-center">
        <div>
          <h4 className="mb-0">Répartition des Abonnés par Groupe</h4>
        </div>
      </div>
