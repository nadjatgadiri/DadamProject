                            ...
                            <div style={{ padding: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                                <Card style={{ padding: '20px', width: '100%' }}>
                                    ...
                                    {type === "formation" ?
                                        <Grid container spacing={3}>
                                            <Grid item xs={6}>
                                                <InputLabel htmlFor="role">Date De Début</InputLabel>
                                            ...
                                            <Grid item xs={6}>
                                                <InputLabel htmlFor="role">Date De Fin D'inscription</InputLabel>
                                                        ...
                                                        type === "formation" ?
                                                            <>
                                                                <Grid xs={6} paddingTop={2}>
                                                                    <Typography level="body-sm" justifySelf="flex-end">Date De Début</Typography>
                                                                </Grid>
                                                                <Grid xs={6} paddingTop={2}>
                                                                    {startDate}
                                                                </Grid>
                                                                <Grid xs={6} paddingTop={2}>
                                                                    <Typography level="body-sm" justifySelf="flex-end">Date De fin</Typography>
                                                                </Grid>
                                                                <Grid xs={6} paddingTop={2}>
                                                                    {endDate}
                                                                </Grid>
                                                                ...
                                                                <Grid xs={6} paddingTop={2}>
                                                                    <Typography level="body-sm" justifySelf="flex-end">Date De fin D'inscription</Typography>
                                                                </Grid>
                                                                <Grid xs={6} paddingTop={2}>
                                                                    {finSubDate1}
                                                                </Grid>
