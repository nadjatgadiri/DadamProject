...
// @mui
import {
    Typography, Container, Paper, Table, TableBody, TableCell, TableRow, TableContainer, Chip,Button
} from '@mui/material';
                            ...
                            <TableRow key={index}>
                                <TableCell noWrap>
                                    <Typography variant="subtitle1">
                                        {row.title}
                                        <Link style={{ color: 'blue' }} to={`/dashboard/ProgrameProfile/${row.prog.id}`}>
                                            <Iconify icon={'akar-icons:link-out'} sx={{ mr: 1 }} style={{ marginLeft: '20px' }} />
                                        </Link>
                                    </Typography>
                                </TableCell>
                                <TableCell>
                ...
                <div className="col-md-3 mb-3">
                    <div className="card d-flex justify-content-center align-items-center">
                        <div className="card-body text-center">
                            ...
                            <Typography variant="h5" style={{ color: '#17a2b8', lineHeight: '3rem' }}>{events.length}</Typography>
                        </div>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card d-flex justify-content-center align-items-center">
                        <div className="card-body text-center">
                            ...
                            <Typography variant="h5" style={{ color: '#28a745', lineHeight: '3rem' }}>{sessionsParticipated.length}</Typography>
                        </div>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card d-flex justify-content-center align-items-center">
                        <div className="card-body text-center">
                            ...
                            <Typography variant="h5" style={{ color: '#28a745', lineHeight: '3rem' }}>{sessionsParticipated.filter(session => session.isPaid).length}</Typography>
                        </div>
                    </div>
                </div>
                <div className="col-md-3 mb-3">
                    <div className="card d-flex justify-content-center align-items-center">
                        <div className="card-body text-center">
                            ...
                            <Typography variant="h5" style={{ color: '#dc3545', lineHeight: '3rem' }}>{sessionsParticipated.filter(session => !session.isPaid).length}</Typography>
                        </div>
                    </div>
                </div>
            </div>
